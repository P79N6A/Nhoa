 ...
 * @class describe：我抄送的适配器
 * @time 2018/7/12 14:13
 * @change
 */
public class CopyToListAdapter extends BaseAdapter {
    private Context context;
    private List<CopyToModel> listData;

    public CopyToListAdapter(Context context, List<CopyToModel> listData) {
