 ...
 * @class describe：弹出选择申请用品的滚轮中左侧的分类列表适配器
 * @time 2018/7/17 9:14
 * @change
 */
public class PopWheelStuffSubjectAdapter extends BaseAdapter {
    private Context context;
    private List<OfficeStuffModel> listData;
    private int selectedPosition =-1;// 选中的位置

    public PopWheelStuffSubjectAdapter(Context context, List<OfficeStuffModel> listData) {
