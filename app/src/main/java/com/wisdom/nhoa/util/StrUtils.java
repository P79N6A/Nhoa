...
//    }
     ...
     * @param context
     * @param content     文字内容
     * @param startIndex1 开始下标
     * @param endIndex1   结束下标
     * @return
     */
    public static SpannableStringBuilder changeTheKeyTextColor2(Context context, String content, int startIndex1, int endIndex1) {
        SpannableStringBuilder spannable = new SpannableStringBuilder(content);
        ForegroundColorSpan orangeSpan1 = new ForegroundColorSpan(context.getResources().getColor(R.color.department_color));
        spannable.setSpan(orangeSpan1, startIndex1, endIndex1, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        return spannable;
    }
