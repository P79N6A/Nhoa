 ...
 */
public class SupervisionSearchDetialAdapter extends RecyclerView.Adapter<SupervisionSearchDetialAdapter.ViewHolder> {
  private  List<SupervisionModel.ChildBean> mData;
   private Context mContext;
    public SupervisionSearchDetialAdapter(Context context, List<SupervisionModel.ChildBean> childBeans) {
     mContext=context;
     mData=childBeans;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_supervision_search_detailed_list,parent,false);
