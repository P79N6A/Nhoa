...
import com.wisdom.nhoa.approval.activity.ChooseCopyToActivity;
...
public class EditSupervisionActivity extends BaseActivity {
    ...
    public void initViews() {
        ...
        et_supervision_name.setText(""+supervisionModel.getName());
        tv_begin_time.setText(""+supervisionModel.getBegintime());
        tv_end_time.setText(""+supervisionModel.getEndtime());
        et_supervision_content.setText(""+supervisionModel.getContent());
        initDataPick();
...
//                选择反馈人的回调
    ...
    public void submitSupervision() {
        ...
        params.put("supervisionid",supervisionModel.getId());
        ...
        HttpUtil.httpPostWithMultipart(ConstantUrl.EDIT_SUPERVISION, params, new StringCallback() {
            @Override
