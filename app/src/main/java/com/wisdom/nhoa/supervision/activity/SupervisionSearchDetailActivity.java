...
public class SupervisionSearchDetailActivity extends BaseActivity {
    ...
    public void initViews() {
        ...
        adapter.setItemClickListener(new SupervisionDetialAdapter.onItemClickListener() {
            ...
            public void onItemClicked(int position, SupervisionModel.ChildBean childBean) {
                Intent intent = new Intent(SupervisionSearchDetailActivity.this, AddFeedBackActivity.class);
                Bundle bundle = new Bundle();
                bundle.putSerializable("data", model);
                intent.putExtras(bundle);
                intent.putExtra("position", position);
                startActivity(intent);
                SupervisionSearchDetailActivity.this.finish();
            }
        });
    ...
    public void setlayoutIds() {
        setContentView(R.layout.activity_supervision_search_detail);
    }
