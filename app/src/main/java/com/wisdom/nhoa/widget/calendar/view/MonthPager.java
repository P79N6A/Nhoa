...
import com.wisdom.nhoa.widget.calendar.behavior.MonthPagerBehavior;
import com.wisdom.nhoa.widget.calendar.component.CalendarViewAdapter;

@DefaultBehavior(MonthPagerBehavior.class)
public class MonthPager extends ViewPager {
    ...
    private MonthPager.OnPageChangeListener monthPageChangeListener;
    ...
    private void init() {
        android.support.v4.view.ViewPager.OnPageChangeListener viewPageChangeListener = new android.support.v4.view.ViewPager.OnPageChangeListener() {
    ...
    public void addOnPageChangeListener(MonthPager.OnPageChangeListener listener) {
