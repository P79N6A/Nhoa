...
/**
 * 悬浮菜单，里面可以放多个悬浮按钮FloatingActionButton
  */
public class FloatingActionsMenu extends ViewGroup {
  ...
  private static final float EXPANDED_PLUS_ROTATION = 180f;
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    for (int i = 0; i < mButtonsCount; i++) {
      ...
      case EXPAND_LEFT:
        ...
        mMaxButtonHeight = Math.max(mMaxButtonHeight, child.getMeasuredWidth());
        break;
      case EXPAND_RIGHT:
        width += child.getMeasuredWidth();
