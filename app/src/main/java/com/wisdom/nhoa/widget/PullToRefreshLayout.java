...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private void initView() {
        // 初始化下拉布局
        pullView = (View) refreshView.findViewById(R.id.pull_icon);
        refreshStateTextView = (TextView)refreshView.findViewById(R.id.state_tv);
        refreshingView =  (View)refreshView.findViewById(R.id.refreshing_icon);
        refreshStateImageView =(View)refreshView.findViewById(R.id.state_iv);
        // 初始化上拉布局
