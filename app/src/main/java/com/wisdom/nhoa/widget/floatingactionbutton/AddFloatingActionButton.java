package com.wisdom.nhoa.widget.floatingactionbutton;
 ...
 * 就加了一个mPlusColor属性,设置图像的颜色，是用来扩展
 *
 */
...
//        canvas.drawRect(iconHalfSize - plusHalfStroke, plusOffset, iconHalfSize + plusHalfStroke, iconSize - plusOffset, paint);
        Bitmap bitmap = ((BitmapDrawable) getResources().getDrawable(R.mipmap.screen)).getBitmap();
          canvas.drawBitmap(bitmap,null,new Rect(0,0,(int)iconSize,(int)iconSize),paint);
      }
    };
