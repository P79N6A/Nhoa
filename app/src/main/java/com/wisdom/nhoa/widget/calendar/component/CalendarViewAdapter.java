package com.wisdom.nhoa.widget.calendar.component;
...
public class CalendarViewAdapter extends PagerAdapter {
    ...
    private CalendarViewAdapter.OnCalendarTypeChanged onCalendarTypeChangedListener;
    ...
    private void init(Context context, final OnSelectDateListener onSelectDateListener) {
        ...
        for(int i = 0; i < 3; ++i) {
            ...
            final Calendar calendar = new Calendar(context, onSelectDateListener, calendarAttr);
            calendar.setOnAdapterSelectListener(new OnAdapterSelectListener() {
                ...
                @Override
                public void onCalendarLongClick(CalendarDate calendarDate) {
                   if (onOnLongClickListener!=null){
                       onOnLongClickListener.onLongClick(calendarDate);
                   }
                }
            });
    ...
    public void setMarkData1(HashMap<String, String> markData) {
        Utils.setMarkData1(markData);
    }
    public void switchToMonth() {
        if (this.calendars != null && this.calendars.size() > 0 && this.calendarType != CalendarAttr.CalendarType.MONTH) {
            ...
            v2.switchCalendarType(CalendarAttr.CalendarType.MONTH);CalendarDate last = this.seedDate.modifyMonth(-1);
            last.setDay(1);
            v2.showDate(last);
    ...
    public void setOnCalendarTypeChangedListener(CalendarViewAdapter.OnCalendarTypeChanged onCalendarTypeChangedListener) {
    ...
    public void setOnOnLongClickListener(OnLongClickListener onOnLongClickListener) {
        this.onOnLongClickListener = onOnLongClickListener;
    }

    private OnLongClickListener onOnLongClickListener;
    public interface OnLongClickListener{
        void onLongClick(CalendarDate calendar);
    }
}
