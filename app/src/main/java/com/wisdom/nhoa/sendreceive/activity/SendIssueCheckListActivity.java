...
import com.wisdom.nhoa.util.http_util.DialogUtil;
...
public class SendIssueCheckListActivity extends BaseActivity implements SendIssueTodoModelAdapter.IssueTodoItemClickListener {
    ...
    public void onIssueTodoItemClicked(RecyclerView recyclerView, int pos, View clickView, SendManageModel sendManageModel) {
        Intent intent = new Intent(this, SendIssueCheckDetailActivity.class);
    ...
    private void getdata() {
        ...
        params.put("access_token", SharedPreferenceUtil.getUserInfo(SendIssueCheckListActivity.this).getAccess_token());
        params.put("listtype", ConstantString.SEND_RECEIVE_LIST_TYPE_COMPLETE);
        ...
        HttpUtil.httpGet(ConstantUrl.RECEIVE_SEND_ISSUE_MANAGMENT, params, new JsonCallback<BaseModel<List<SendManageModel>>>() {
            ...
            public void onSuccess(BaseModel<List<SendManageModel>> listBaseModel, Call call, Response response) {
                ...
                if (list.size() == 0) {
                    ...
                    SendIssueTodoModelAdapter adapter = new SendIssueTodoModelAdapter(SendIssueCheckListActivity.this, list);
                    approvalRecyclerView.setAdapter(adapter);
                    adapter.notifyDataSetChanged();
                    adapter.setIssueTodoItemClickListener(SendIssueCheckListActivity.this);
                }
            }
