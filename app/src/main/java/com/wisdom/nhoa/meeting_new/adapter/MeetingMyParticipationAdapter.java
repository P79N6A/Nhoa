 ...
 * @change
 */
public class MeetingMyParticipationAdapter extends RecyclerView.Adapter<MeetingMyParticipationAdapter.MySponsorListHolder> implements View.OnClickListener {
    ...
    public MeetingMyParticipationAdapter(List<MeetingMySponsorModel> listData, Context context) {
    ...
    public MySponsorListHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.item_meeting_my_participation, null, false);
